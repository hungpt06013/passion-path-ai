...
// 2. GET /api/roadmaps/:id - Lấy chi tiết 1 lộ trình
...
// 3. GET /api/roadmaps/:id/details - Lấy chi tiết từng ngày học
...
// 4. PUT /api/roadmaps/details/:id/status - Cập nhật trạng thái ngày
...
// 5. PUT /api/roadmaps/:id/update-details - Cập nhật thông tin chi tiết lộ trình
      ...
      if (overall_rating >= 4 || learning_effectiveness >= 4) {
        ...
        if (systemCheck.rows.length > 0) {
          ...
          if (updatedAnalysis) {
            await client.query(
              `UPDATE learning_roadmaps_system 
              SET roadmap_analyst = $1, duration_days = $2, duration_hours = $3,
                  updated_at = (NOW() AT TIME ZONE 'Asia/Ho_Chi_Minh') 
              WHERE roadmap_id = $4`,
...
// 6. DELETE /api/roadmaps/:id - Xóa lộ trình
